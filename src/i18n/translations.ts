...
export const messages: Record<Locale, Translation> = {
  uz: {
    ...
    createAccount: 'Hisob yarating', createAccountDescription: "SmartWallet ni xavfsiz boshlash uchun email va parolni kiriting.", signInDescription: "Moliyaviy ma'lumotlaringizga xavfsiz kiring.", signInAction: 'Kirish', registerAction: 'Hisob yaratish', noAccount: "Hisobingiz yo'qmi?", haveAccount: 'Hisobingiz bormi?',
